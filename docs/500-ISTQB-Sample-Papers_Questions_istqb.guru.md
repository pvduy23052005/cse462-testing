ISTQB Sample Paper
2010-2011
This document contains sample questions collected
and collated from various exam sites, user forums,
www.
| blogs  and  | recent  sample  | questions  provided  | by     |
| ----------- | --------------- | -------------------- | ------ |
| examinees.  | For  more       | sample  questions    | visit  |
www.istqb.guru
istqb.guru

ISTQB Sample Papers [2010 -2011]
Q. 1: Given the following state transition table Which of the test cases below will cover
...
Q. 4: Which of the following BEST describes the difference between an inspection and a
walkthrough?
...
C. Test closure.
D. Test control.
Q. 13: Given the following state transition diagram Which of the following series of
...
Q. 16: Given the following fragment of code, how many tests are required for 100%
decision coverage?
if width > length
then
...
C. 2
D. 1
Q. 17: You have designed test cases to provide 100% statement and 100% decision
...
Q. 18: A thermometer measures temperature in whole degrees only. If the temperature
...
C. 18, 20 and22.
D. 16, 26 and 32.
Q. 19: Which activity in the fundamental test process creates test suites for efficient
test execution?
...
A. Confirmation testing is testing fixes to a set of defects and Regression testing is testing
to establish whether any defects have been introduced as a result of changes.
B. Confirmation testing is testing to establish whether any defects have been introduced as
a result of changes and Regression testing is testing fixes to a set of defects.
...
ISTQB Sample Papers [2010 -2011]
Q. 21: Given the following decision table: Which of the following test cases and
expected results is VALID?
Rule 1 Rule 2 Rule 3 Rule 4
Conditions
Age <21 21-29 yrs 30-50yrs > 50yrs
yrs
Insurance A A or B B. C or D C or D
Class
Actions
...
Q. 27: Which of the following benefits are MOST likely to be achieved by using test
tools?
...
C. i and iv
D. i and iii
Q. 28: What is the KEY difference between preventative and reactive approaches to
testing?
8 www.istqb.guru
...
Q. 31: With which of the following categories is a test comparator tool USUALLY
associated?
...
C. 1Z, 2X, 3W, 4Y.
D. 1Z, 2Y, 3X, 4W.
Q. 34: Which type of test design techniques does the following statement best describe
...
Q. 36: Which of the following types of defects is use case testing MOST LIKELY to
uncover?
...
Q. 41: Which of the following combinations correctly describes a valid approach to
component testing:
...
Q. 46: There are several risks of managing your project's schedule with a statistical
reliability model. These include (choose one or more of the following):
A. Testers spend more energy early in the product trying to find bugs than preparing to do
...
because they expect a low rate of bug finding, so the low rate achieved doesn't alarm
them.
C. It can increase the end-of-project pressure on testers to not find bugs, or to not report
bugs.
D. All of the above
...
B. The failure depends on the program's inability to handle specific data values, rather than
on the program's flow of control.
...
B. We don't know how to measure a variable (our measurement is dysfunctional) and so we
don't know how to interpret the result.
C. You are measuring the wrong thing and thus reaching the wrong conclusions.
D. All of the above.
Q. 51: Important consequences of the impossibility of complete testing are (Choose one
or more answers):
A. We can never be certain that the program is bug free.
B. We have no definite stopping point for testing, which makes it easier for some managers
...
D. Debugging defects
Q. 57: Maintenance releases and technical assistance centers are examples of which of
...
Q. 60: Who is responsible for document all the issues, problems and open point that
...
ISTQB Sample Papers [2010 -2011]
Q. 61: ‘X’ has given a data on a person age, which should be between 1 to 99. Using
...
Q. 63: A project that is in the implementation phase is six weeks behind schedule.
...
Q. 64: The ___________ Testing will be performed by the people at client own
locations
A. Alpha testing
B. Field testing
...
Q. 70: One person has been dominating the current software process improvement
meeting. Which of the following techniques should the facilitator use to bring other
team members into the discussion?
...
D. Express an opinion that differs from the person’ s opinion in order to encourage others to
express their ideas.
Q. 71: Stochastic testing using statistical information or operational profiles uses the
following method
17 www.istqb.guru
...
C. Analysis and design
D. None
Q. 81: The ________ and ________ are used within individual workbenches to produce
...
C. Scalability
D. Maintainability
Q. 83: The principle of Cyclomatic complexity, considering L as edges or links, N as
...
D. Sanity testing
Q. 89: A Test Plan Outline contains which of the following:
i. Test Items
ii. Test Scripts
20 www.istqb.guru
...
Q. 90: Testing where in we subject the target of the test , to varying workloads to
...
Q. 98: The Phases of formal review process is mentioned below arrange them in the
correct order.
i. Planning
ii. Review Meeting
iii. Rework
...
D. Sanity Testing
Q. 101: The Switch is switched off once the temperature falls below 18 and then it is
...
test case.
Q. 103: Which of the following is not a part of the Test Implementation and Execution
Phase
...
Q. 107: Designing the test environment set-up and identifying any required
infrastructure and tools are a part of which phase
A. Test Implementation and execution
B. Test Analysis and Design
C. Evaluating the Exit Criteria and reporting
D. Test Closure Activities
Q. 108: A Type of functional Testing, which investigates the functions relating to
detection of threats, such as virus from malicious outsiders.
A. Security Testing
B. Recovery Testing
C. Performance Testing
D. Functionality Testing
Q. 109: A Person who documents all the issues, problems and open points that were
...
Q. 111: One of the fields on a form contains a text box which accepts alpha numeric
values. Identify the Valid Equivalence class
A. BOOK
B. Book
C. Boo01k
D. book
Q. 112: In a Examination a candidate has to score minimum of 24 marks inorder to clear
the exam. The maximum that he can score is 40 marks. Identify the Valid Equivalance
values if the student clears the exam.
A. 22,23,26
B. 21,39,40
C. 29,30,31
D. 0,15,22
Q. 113: Verification involves which of the following :-
...
Q. 122: One of the fields on a form contains a text box which accepts numeric values in
the range of 18 to 25. Identify the invalid Equivalance class
A. 17
B. 19
C. 24
D. 21
...
C. Development Phase
D. Testing Phase
Q. 130: The specification which describes steps required to operate the system and
exercise test cases in order to implement the associated test design
A. Test Case Specification
B. Test Design Specification
C. Test Procedure Specification
D. None
Q. 131: How much percentage of the life cycle costs of a software are spent on
maintenance.
28 www.istqb.guru
...
C. 50%
D. 70%
Q. 132: When a defect is detected and fixed then the software should be retested to
confirm that the original defect has been successfully removed. This is called
A. Regression testing
B. Maintenance testing
C. Confirmation testing
D. None of the above
Q. 133: Equivalence testing divides the input domain into classes of data from which
...
D. None above
Q. 135: With thorough testing it is possible to remove all defects from a program prior
...
Q. 137: ________indicates how important it is to fix the bug and when it should be
fixed
29 www.istqb.guru
...
C. All of the above
D. None of the above
Q. 138: The person who leads the review of the document(s), planning the
...
D. Branch Testing
Q. 140: Quality Assurance is the process by which product quality is compared with the
application standards and the action taken when nonconformance is detected.
A. True
B. False
Q. 141: A formal assessment of a work product conducted by one or more qualified
...
C. Test Cycle
D. Test Driver
Q. 143: Configuration and compatibility testing are typically good choices for
outsourcing
30 www.istqb.guru
...
Q. 146: During this event the entire system is tested to verify that all functional
...
D. None of the above
Q. 148: The goal of a software tester is to find bugs, find them as early as possible and
make sure they get fixed.
A. True
B. False
Q. 149: Beta testing is performed at developing organization's site where as Alpha
testing is performed by people at their own locations.
31 www.istqb.guru
...
C. All of the above
D. None of the above
Q. 151: In ______ testing doesn't know anything about the sofware being tested; it just
clicks or types randomly.
A. Random testing
B. Gorilla testing
C. Adhoc testing
D. Dumb monkey testing
Q. 152: A series of probing questions about the completeness and attributes of an
application system is called
A. Checklist
B. Checkpoint review
C. Decision table
D. Decision tree
Q. 153: The testing technique that requires devising test cases to demonstrate that
each program function is operational is called
A. Black-box testing
B. Glass-box testing
C. Grey-box testing
D. White-box testing
Q. 154: A white box testing technique that measures the number of or percentage of
...
A. True
B. False
Q. 159: Which testing is used to verify that the system can perform properly when
internal program or system limitations have been exceeded
A. Stress Testing
B. Load Testing
C. Performance Testing
D. Volume testing
Q. 160: Defects are recorded into three major purposes. They are:
...
Q. 164: ________is a very early build intended for limited distribution to a few key
...
D. None
Q. 166: The tool modifies the program code or manipulates tge operating environment
...
A. True
B. False
Q. 170: Tool which stores requirement statements, check for consistency and allow
requirements to be prioritized and enable individual tests to be traceable to
requirements, functions and features.
A. Incident management tools
B. Requirements management tools
C. Configuration management tools
D. None
Q. 171: The number of tests to test all control statements equals the cyclomatic
complexity
A. True
B. False
...
ISTQB Sample Papers [2010 -2011]
Q. 175: During the software development process, at what point can the test process
start?
...
Q. 177: Which of the following tools would be involved in the automation of regression
test?
A. Data tester
B. Boundary tester
C. Capture/Playback
...
ISTQB Sample Papers [2010 -2011]
Q. 181: Which of the following is not a quality characteristic listed in ISO 9126
Standard?
A. Functionality
B. Usability
C. Supportability
...
C. 4
D. 5
Q. 185: To test a function, the programmer has to write a _________, which calls the
...
Q. 189: How many test cases are necessary to cover all the possible sequences of
statements (paths) for the following program fragment? Assume that the two conditions
...
Q. 200: What is the difference between testing software developed by contractor
...
C. Number bound for the number of tests that must be conducted to ensure that all
...
Q. 315: Which of the following is a type of non-functional testing?
A. Usability testing.
...
Q. 319: A field failure occurs when multiple users access a system. Which of the
following is true?
...
Q. 322: Exclusive use of white box testing in a test-phase will:
...
Q. 326: Which of the following provides the biggest potential cost saving from use of
CAST?
A. Test management
B. Test design
C. Test planning
...
Q. 332: In a system designed to work out the tax to be paid: An employee has $4000 of
salary tax free. The next $1500 is taxed at 10% The next $28000 is taxed at 22% Any
further amount is taxed at 40%
...
Q. 335: The later in the development life cycle a fault is discovered, the more
...
D. None of the above
Q. 336: Which of the following is true?
...
Q. 337: If the pseudo code below were a programming language ,how many tests are
...
Q. 339: Using the same code example as question 17,how many tests are required to
...
than or equal to 22 are rejected. Which of the following covers the MOST boundary values?
A. 9,10,11,22
B. 9,10,21,22
C. 10,11,21,22
D. 10,11,20,21
...
Values less than 10 are rejected, values between 10 and 21 are accepted, values greater
than or equal to 22 are rejected. Which of the following input values cover all of the
equivalence partitions?
A. 10,11,21
B. 3,20,21
C. 3,10,22
...
Q. 364: A number of critical bugs are fixed in software. All the bugs are in one module,
...
review
C. Only non-functional requirements are tested; functional requirements are validated in a
review
...
ISTQB Sample Papers [2010 -2011]
Q. 387:If a program is tested and 100% condition coverage is achieved, which of the
following coverage criteria is then guaranteed to be achieved?
...
Q. 388: Which of the following can be root cause of a bug in a software product?
...
D. (I), (II) and (IV) are correct
Q. 389: The following list contains risks that have been identified for a software
...
Q. 392: A test engineer is testing a Video Player (VCR), and logs the following report:
...
Q. 399: The _______ testing should include operational tests of the new environment
as well as of the changed software
A. System Testing
B. Integration testing
C. Component testing
D. Maintenance testing
Q. 400: A risk-based approach to testing provides proactive opportunities to reduce the
...
D. All the above
Q. 403: The _________ Is the activity where general testing objectives are transformed
into tangible test conditions and test designs
A. Testing Planning
B. Test Control
C. Test analysis and design
D. Test implementation
Q. 404: Integration testing where no incremental testing takes place prior to all the
system’s components being combined to form the system.
A. System testing
B. Component Testing
C. Incremental Testing
D. Big bang testing
Q. 405: A test case design technique for a component in which test cases are designed
...
D. Path Coverage
Q. 412: _________ reviews are often held with just the programmer who wrote the
code and one or two other programmers or testers.
A. Formal Reviews
B. Peer Reviews
C. Semi Formal Reviews
D. All of the above
Q. 413: In ________ testing test cases i.e input to the software are created based on
...
A. The data required for testing, the infrastructure requirements to manage the data as
well as the methods for preparing test data, requirements, converters and sources
B. Details what types of tests must be conducted, what stages of testing are required and
outlines the sequence and timing of tests
C. A testing goal. It is a statement of what the tester is expected to accomplish or validate
during a testing activity. These guide the development of test cases and procedures
D. None of the above
...
C. Both A. and B.
D. Neither A. nor B.
Q. 429: If the application is complex, but NOT data intensive and is to be tested on one
configuration and 2 rounds, the easiest method to test is
A. Manual testing
...
Q. 462: Which of these activities provides the biggest potential cost saving from the use
of CAST?
A. Test management
B. Test design
C. Test execution
...
ISTQB Sample Papers [2010 -2011]
Q. 479: Given the following sets of test management terms (v-z), and activity
...
Q. 485: Which of the following is the best source of Expected Outcomes for User
Acceptance Test scripts?
A. Actual results
B. Program specification
C. User requirements
D. System specification
Q. 486: Which of the following are disadvantages of capturing tests by recording the
...
software.
B. An independent tester may be more focused on showing how the software works than the
...
Q. 490: Given the following specification, which of the following values for age are in
the SAME equivalence partition?
If you are less than 18, you are too young to be insured. Between 18 and 30 inclusive, you
will receive a 20% discount. Anyone over 30 is not eligible for a discount.
A. 17, 18, 19.
B. 29, 30, 31.
C. 18, 29, 30.
D. 17, 29, 31.
...
Q. 493: During which fundamental test process activity do we determine if MORE tests
are needed?
A Test implementation and execution.
...
ISTQB Sample Papers [2010 -2011]
This sample paper is collated and uploaded
by www.istqb.guru

http://www.istqb.guru/istqb-dumps-sure-pass-istqb-foundation-level-study-materials/
Pass ISTQB in FIRST Attempt. No
one failed with our Study Guide.
Save yourself from embarrassment of failing ISTQB
exam. With our study materials, no one ever failed. You
will pass your exam in the first attempt itself. If you have
already failed in your previous attempt, then you should
get this study guide this time. Get your ISTQB
Certification and show the world that you passed this
certification with high scores. We have compiled the best
materials for ISTQB Foundation Levels (and hundreds
of already successful ISTQB aspirants agree).
Free Bonus Gift Included!
Bonus:Access to ISTQB Audio MP3 files. These will be
very useful and you can listen to them using your smart
phone, home audio system or in car while you are
travelling. It is a guaranteed strategy to pass your exam
in the first attempt. These audio files include most
important concepts, definitions and sample questions.
Don’t miss our bonus offer.
Your one-time payment of $35 gets you instant
access. Order today!
www.ISTQB.guru
And with this little price you will get:
· Latest syllabus based 400+ premium questions and 1600+ sample practice questions
· Books, Guides, Flashcards – easy to study and remember
· All in one downloadable zipped file
· Save your time, training fee and you will pass in your first attempt
http://www.istqb.guru/istqb-dumps-sure-pass-istqb-foundation-level-study-materials/
Stop yourself trying to figure out how to succeed in your ISTQB Exam. Instead, take benefit of this
study guide which has helped over thousands of ISTQB aspirants since 2009.
Who should use this study guide?
Anyone who is attempting ISTQB Foundation Level for any country board such as ASTQB (USA), ITB (India), ANZTB
(Australia/New Zealand) , Canada, UKTB (UK) or any other boards/countries. The ISTQB Foundation Level syllabus
is same everywhere and these study materials is good for passing the Foundation Level exam anywhere.
http://www.istqb.guru/istqb-dumps-sure-pass-istqb-foundation-level-study-materials/
www.istqb.guru